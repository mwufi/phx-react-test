defmodule PhxreactestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhxreactestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhxreactestWeb.Gettext, "errors", msg, opts)
    end
  end
